...
<body>
    ...
    <h2 class="titulo-larios">PALMA DE MALLORCA</h2>
    <div id="contenedor-larios">
        <div id="foto-nombre">
            <div>
                <img class="foto-encargado-sandra" src="../imagenes/Sandra.webp" alt="">
                <p>Sandra Navalon</p>  
            </div>
            <div id="horarios1">
                <h2>Horario</h2>
               <b><p>¡ Esperamos ilusionados verle ! <br></b>
                Lunes: 12:30-23:00<br>
                Martes: 12:30-23:00<br>
                Miercoles: 12:30-23:00<br>
                Jueves: 12:30-23:00<br>
                Viernes: 12:30-23:00<br>
                Sabado: 12:30-23:00<br>
                Domingo: 12:30-23:00<br>
                <b>Reserva Online <a href="../reservar/reservas.php">clic AQUI</a></p></b>
            </div>            
        </div>
        <div id="direccion-mapa">
            <p class="parrafo-direccion">Paseo Mallorca, 16<br>
                07012, Palma de Mallorca<br><a href="">667-101-982</a>☎️<br>
                A lado de la C/Jaime III</p>
            <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1828.6463072060767!2d2.6400396955530936!3d39.57303875541014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1297925c5e1816df%3A0x654435decd37dec5!2sBlock%20House%20Palma!5e0!3m2!1ses!2ses!4v1690785764524!5m2!1ses!2ses" 
    ...
    <div class="gallery">
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-palma.webp" alt="">
        </div>
        <div class="image">
          <img class="imagenes-restaurantes" src="../imagenes/foto-palma1.webp" alt="Descripción de la imagen 2">
        </div>
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-palma2.webp" alt="Descripción de la imagen 2">
          </div>
      </div>
