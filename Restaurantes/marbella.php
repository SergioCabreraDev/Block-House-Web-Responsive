...
<body>
    ...
    <h2 class="titulo-larios">MARBELLA</h2>
    <div id="contenedor-larios">
        <div id="foto-nombre">
            <div>
                <img class="foto-encargado" src="../imagenes/mariajose.webp" alt="">
                <p>Maria Jose Barba Pérez</p>  
            </div>
            <div id="horarios1">
                <h2>Horario</h2>
               <b><p>¡ Esperamos ilusionados verle ! <br></b>
                Lunes: 12:30-22:00<br>
                Martes: 12:30-22:00<br>
                Miercoles: 12:30-22:00<br>
                Jueves: 12:30-22:00<br>
                Viernes: 12:30-22:30<br>
                Sabado: 12:30-22:30<br>
                Domingo: 12:30-22:00<br>
                    <b>Reserva Online <a href="#">clic AQUI</a></p></b>
            </div>            
        </div>
        <div id="direccion-mapa">
            <p class="parrafo-direccion">Centro Comercial La Cañada
                29603, Marbella.<br><a href="">952-866-060</a>☎️<br>
                En el Centro Comercial La Cañada
                a lado de los cines</p>
            <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3206.3267017194216!2d-4.87602100210298!3d36.522111830922654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd72d8123e04b155%3A0x9716e475d712648a!2sBlock%20House!5e0!3m2!1ses!2ses!4v1689837918030!5m2!1ses!2ses" 
    ...
    <div class="gallery">
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-marbella.webp" alt="">
        </div>
        <div class="image">
          <img class="imagenes-restaurantes" src="../imagenes/foto-marbella2.webp" alt="Descripción de la imagen 2">
        </div>
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-marbella1.webp" alt="Descripción de la imagen 2">
          </div>
      </div>
