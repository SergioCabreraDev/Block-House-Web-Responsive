...
<body>
    ...
    <h2 class="titulo-larios">PORTO PI</h2>
    <div id="contenedor-larios">
        <div id="foto-nombre">
            <div>
                <img class="foto-encargado-xisco" src="../imagenes/Xisco.webp" alt="">
                <p>Xisco Lopez</p>  
            </div>
            <div id="horarios1">
                <h2>Horario</h2>
        ...
        <div id="direccion-mapa">
            <p class="parrafo-direccion">Centro Comercial Porto Pi
                Avda Gabriel Roca, 54<br>
                07015, Palma de Mallorca<br><a href="">637-070-853</a>☎️<br>
                En Porto Pi Terrazas con vistas al puerto</p>
            <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2175.343611714394!2d2.61964270256613!3d39.550577540299095!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12979208878b2365%3A0x76b738a68461a8d1!2sBlock%20House%20Porto%20Pi!5e0!3m2!1ses!2ses!4v1690789823327!5m2!1ses!2ses" 
    ...
    <div class="gallery">
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-portopi.webp" alt="">
        </div>
        <div class="image">
          <img class="imagenes-restaurantes" src="../imagenes/foto-portopi2.webp" alt="Descripción de la imagen 2">
        </div>
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-portopi1.webp" alt="Descripción de la imagen 2">
          </div>
      </div>
