...
<body>
    ...
    <h2 class="titulo-larios">MÁLAGA PLAZA MAYOR</h2>
    <div id="contenedor-larios">
        <div id="foto-nombre">
            <div>
                <img class="foto-encargado" src="../imagenes/Patricia.webp" alt="">
                <p>Patricia Gonzáles</p>  
            </div>
            <div id="horarios1">
                <h2>Horario</h2>
               <b><p>¡ Esperamos ilusionados verle ! <br></b>
                    Lunes: 13:00-23:00<br>
                    Martes: 13:00-23:00<br>
                    Miercoles: 13:00-23:00<br>
                    Jueves: 13:00-23:00<br>
                    Viernes: 12:30-23:45<br>
                    Sabado: 12:30-23:45<br>
                    Domingo: 13:00-23:00<br>
                    <b>Reserva Online <a href="../reservar/reservas.php">clic AQUI</a></p></b>
            </div>            
        </div>
        <div id="direccion-mapa">
            <p class="parrafo-direccion">Centro Comercial Plaza Mayor<br>
                C/Alfonso Ponce de León, 3-2, 29140, Málaga. <br><a href="">666-104-000</a>☎️<br>
                En el Centro Comercial Plaza Mayor</p>
            <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12802.989306654474!2d-4.4793553!3d36.6565288!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd72f9ca792c0247%3A0x32010562d6339266!2sBlock%20House%20Plaza%20Mayor!5e0!3m2!1ses!2ses!4v1692724288255!5m2!1ses!2ses" 
    ...
    <div class="gallery">
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/malaga-plazamayor.webp" alt="">
        </div>
        <div class="image">
          <img class="imagenes-restaurantes" src="../imagenes/malaga-plazamayor1.webp" alt="Descripción de la imagen 2">
        </div>
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/malaga-plazamayor2.webp" alt="Descripción de la imagen 2">
          </div>
      </div>
