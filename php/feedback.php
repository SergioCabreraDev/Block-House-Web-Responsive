...
<h3>FEEDBACK</h3>
<b><p>Apreciamos los comentarios. Nos gustaría saber cómo ha sido experiencia en Block House.</p></b>

<form class="formulario_factura" action="" method="post">
    
<b> <label  for="">Restaurante:</label></b> <br class="br_pantallaipad">
 <select class="input-factura" name="Concepto"  required>
            ...
            <label  for="">Comentario:</label></b><br>
              <textarea  rows="4"></textarea> <br>
            </div>
           
            <button type="submit"><b>Enviar Feedback</b></button>     
</form>
</div>
<script>
