...
$nombre_usuario = ""; // Inicializa la variable $nombre_usuario
...
<body>
    ...
    <center>
        ...
        <div class="contenedor_inicio_exitoso">
            <h2>Bienvenido a la página de miembros Block House, <?php echo $nombre_usuario; ?>!</h2>
            <p class="cerrarsesion_p">Si desea cerrar sesion pulse en este boton.</p>
    ...
    <footer class="footer_inicioexitoso">
        <div class="footer-content">
            <ul class="footer-links">
                ...
                <li><a href="#">
                        <p>Administracion Central</p>
                    </a></li>
            </ul>
            <ul class="footer-links">
                <li><a href="../index.php">Inicio</a></li>
                <li><a href="../empresa.php">Empresa</a></li>
                <li><a href="https://www.facebook.com/blockhouseES/"><svg style="color: white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
