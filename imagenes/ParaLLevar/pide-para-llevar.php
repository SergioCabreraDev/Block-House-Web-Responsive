...
<body>
    ...
    <form class="formulario-reserva" action="../php/realizar_reserva.php" method="POST">
        ...
        <div id="formulario-takeaway">
        
            <div id="formulario-takeaway2">
                <h3 class="tituloparallevar">Calidad Block House para llevar. Haz tu pedido aquí.</h3>
                <p>Haz tu pedido para recoger. Tu comida recién hecha, lista y envasada. <br><br>
    
                    Así funciona:<br>
                    
                    - Seleccionar el restaurante donde recogerás tu pedido.<br>
                    - Seleccionar la hora de tu recogida.<br>
                    - Seleccionar la comida de nuestra Carta Especial 'Para llevar'.<br>
                    - Pagar online con tarjeta de credito/debito.<br>
                    - Anotar el código de recogida.<br>
                    - ¡Se puntual, la comida estará lista para recoger a la hora fijada!</p>
                    <center><button class="button-takeaway">¡Vamos, A pedir!</button></center>
                    
        </div>
        </div>

        <div id="formulario-takeaway1">
            <h3 class="tituloparallevar1">Calidad Block House para llevar. Haz tu pedido aquí.</h3>
            <p>Haz tu pedido para recoger. Tu comida recién hecha, lista y envasada. <br><br>
                ...
                - Anotar el código de recogida.<br>
                - ¡Se puntual, la comida estará lista para recoger a la hora fijada!</p>
                <center><button class="button-takeaway1">¡Vamos, A pedir!</button></center>
