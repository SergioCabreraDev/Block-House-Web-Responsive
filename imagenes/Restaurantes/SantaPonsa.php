...
<body>
    ...
    <h2 class="titulo-larios">SANTA PONSA</h2>
    <div id="contenedor-larios">
        <div id="foto-nombre">
            <div>
                <img class="foto-encargado" src="../imagenes/almeida.webp" alt="">
                <p>Francisco Almeida</p>  
            </div>
            <div id="horarios1">
                <h2>Horario</h2>
               <b><p>¡ Esperamos ilusionados verle ! <br></b>
                Lunes:	12:30-22:30<br>
                Martes:	12:30-22:30<br>
                Miercoles:	12:30-22:30<br>
                Jueves:	12:30-22:30<br>
                Viernes:	12:30-23:00<br>
                Sabado:	12:30-23:00<br>
                Domingo:	12:30-22:30<br>
                    <b>Reserva Online <a href="#">clic AQUI</a></p></b>
            </div>            
        </div>
        <div id="direccion-mapa">
            <p class="parrafo-direccion">Plaza Central <br>
                07180, Santa Ponsa<br><a href="">971-594-500</a>☎️<br>
                Adyacente al parking publico grande</p>
            <iframe class="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2588.29527293233!2d2.481647792608726!3d39.51405738585693!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x129789b9a6187acf%3A0xfadd30a74a5957f1!2sBlock%20House%20Sta.%20Pon%C3%A7a!5e0!3m2!1ses!2ses!4v1690786724174!5m2!1ses!2ses" 
    ...
    <div class="gallery">
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-santaponsa.webp" alt="">
        </div>
        <div class="image">
          <img class="imagenes-restaurantes" src="../imagenes/foto-santaponsa1.webp" alt="Descripción de la imagen 2">
        </div>
        <div class="image">
            <img class="imagenes-restaurantes" src="../imagenes/foto-santaponsa2.webp" alt="Descripción de la imagen 2">
          </div>
      </div>
