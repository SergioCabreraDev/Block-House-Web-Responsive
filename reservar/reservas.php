...
<body>
   ...
   <select class="input-reserva1" name="hora" id="hora" required onchange="validarHora()">
    ...
    ?>
               ...
               <input class="input-reserva1" type="number" id="campo3" name="personas" max="6" placeholder="Numero de Personas" required>
   
                <!-- Campo de nombre -->
       <b><label class="label-reserva1" for="nombre">NOMBRE:</label></b>
       <input class="input-reserva1" type="text" id="nombre" name="nombre" placeholder="Nombre del Cliente" required>
