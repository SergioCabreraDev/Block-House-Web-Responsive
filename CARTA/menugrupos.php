...
<body>
    ...
    <center>
        ...
        <div id="contenido-grupos">
            <div class="texto-grupos">
                <h3>Celebra con 4 menús diferentes</h3>
                <p>Debajo de este recuadro, haz click sobre el menú que encaja con tu presupuesto y descubre las opciones.
                        <br><br>
                    Las condiciones que se aplican con los menús son las siguientes: <br>
                    - Grupo mínimo de 12 personas <br>
                    - Previa reserva y acuerdo con el encargado de tu restaurante <br>
                    - Emisión de una factura y pago único por grupo <br>
                    <br>
                    ¡En cada uno de los menús tienes la opción de añadir un plus con la opción de bebida libre! <br>
                    <br>
                    Descubre tu menú.
                    </p>
            </div>
            <div class="lista-menus">
                <p class="menus"><a class="linkmenu" href="menugrupos/menuI.php">Menu I</a></p>
                <p class="menus"><a class="linkmenu" href="menugrupos/menuII.php">Menu II</a></p>
                <p class="menus"><a class="linkmenu" href="menugrupos/menuIII.php">Menu III</a></p>
                <p class="menus"><a class="linkmenu" href="menugrupos/menuIV.php">Menu IV</a></p>
            </div>
