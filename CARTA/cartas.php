...
<body>
 ...
 <center>
    <h3 class="titulocartas">BLOCK HOUSE CARTAS</h3>
    <p class="frasecarta"><b>En Block House, nuestra pasión es ofrecerte una experiencia culinaria única y +
        llena de sabor. Te invitamos a disfrutar de nuestros platos cuidadosamente 
        preparados con ingredientes frescos y de la más alta calidad, para que cada 
        visita sea una experiencia inolvidable. 
        ¡Ven y déjanos sorprenderte con nuestro auténtico y delicioso menú! <br><br> </b>
    Celebra en Block House, reservar tu comida o cena de empresa, familiares o amigos <a href="menugrupos.php">(pulse aqui)</a>
    </p>
</center>
    <div id="contenedor-de-cartas">
    <div class="cartademenu">
        <a class="linkcartas" href="cartamenu.php"><p >MENU</p></a>
    </div>
    <div class="postres">
        <a class="linkcartas" href="postres.php"><p>POSTRES</p></a>
    </div>
    <div class="cartaniños">
        <a class="linkcartas" href="menuniño.php"><p>CARTA DE NIÑO</p></a>
    </div>
    <div class="nuestrosvinos">
      <a class="linkcartas" href="vinos.php"><p>VINOS</p></a>
    </div>   
    </div>
